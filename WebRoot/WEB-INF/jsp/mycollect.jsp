					...
					<div id="mynav2"
						...
						<nav class="UnderlineNav-body">
							<a href="/weshare/file/itempage" class="UnderlineNav-item ">
								...
								class="UnderlineNav-item selected"> 我的收藏<span
					...
					<div class="position-relative">
						<div id="user-repositories-list">
							<ul id="ul_se" data-filterable-for="your-repos-filter"
								...
								<c:if test="${empty myCollect }">
									<div id="user-repositories-list">
										<div class="blankslate mt-5">
											<h4 style="font-weight:500;font-size:15px;">你还没有收藏任何资源哦!</h4>
										</div>
									</div>
								</c:if>

								<c:forEach items="${myCollect }" var="file">
									...
									<li class="col-12 d-block width-full py-4 border-bottom"
										...
										<div class="d-inline-block col-9 mb-1">
											...
											<%-- <a href="/weshare/collect/delcollect?fileName=${file.fName }">删除</a> --%>
										...
										<!-- ？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？？ -->
											...
											<div
												...
												<a href="####" class="downurl" style="margin-right:5px;" data-check="${checkurl }"
												data-url="${downurl }"><img
												src="${ctx }/images/download.png" height="20" width="17"
												alt="下载" title="下载" /></a>
												<a
													href="/weshare/collect/delcollect?fileName=${file.fName }">
													<img src="${ctx }/images/deletefile.png" height="20" width="17"
													alt="删除" title="删除" /></a>
										...
										<div class="f6 text-gray mt-2">
											...
											</span> <!-- !!!!!! -->所需积分：<strong class="myfont4"
												style="color:#EC610A;">${file.fIntegral}</strong> <span
												class="d-inline-block mr-3"> 上传者 <a
