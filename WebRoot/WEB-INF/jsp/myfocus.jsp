					...
					<div
						...
						<div
							...
							<span class="p-nickname vcard-username myfont1"
								...
								itemprop="additionalName">${focusNum }</span><span
								class="myfont1" style="font-weight:600;"> | </span> <span
								class="p-nickname vcard-username myfont1"
								itemprop="additionalName">粉丝: </span> <span
								class="p-nickname vcard-username myfont1"
								itemprop="additionalName">${beFocusNum }</span><span
								class="myfont1" style="font-weight:600;"> | </span> <span
								class="p-nickname vcard-username myfont1"
				...
				<div id="myfix" class="col-9 float-left pl-2">
					...
					<div id="mynav2"
						...
						<nav class="UnderlineNav-body">
							...
							</a> <a href="/weshare/focus/myfocus"
								class="UnderlineNav-item selected"> 我的关注 <span
                                ...
                                <c:if test="${empty myFocus }">
									<div id="user-repositories-list">
										<div class="blankslate mt-5">
											<h4 style="font-weight:500;font-size:15px;">你还没有关注任何人哦!</h4>
										</div>
									</div>
								</c:if>
								<c:forEach items="${myFocus }" var="user">
									...
									<div
										...
										<div class="d-table-cell col-1 v-align-top">
											<a href=""> <img class="avatar"
												src="${ctx }/static/${user.uHead }" alt="@lamhotsimamora"
												width="50" height="50">
											</a>
										</div>

										<div class="d-table-cell col-9 v-align-top pr-3">
											<a href="/weshare/file/otherFile?author=${user.username }"
												class="d-inline-block no-underline mb-1 float-left"> <span
												class="f4 link-gray-dark ">${user.username }</span>
