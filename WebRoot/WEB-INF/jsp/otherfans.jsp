...
<link rel="stylesheet" type="text/css"
	href="${ctx }/emotions/emoticon.css" />
...
<body class="logged-in env-production page-profile intent-mouse">
		...
		<header class="Header  f5" role="banner">
			...
			<div class="d-flex px-3 flex-justify-between container-lg">
						...
						<ul
							...
							<li><a href="/weshare/file/itempage"
								...
								data-selected-links="/pulls /pulls/assigned /pulls/mentioned /pulls">
									我的主页 </a></li>
							<li><a href="/weshare/friendscircle/select"
				...
				<div class="d-flex">
					...
					<ul class="user-nav d-flex flex-items-center list-style-none"
						id="user-links">
						<li class="dropdown js-menu-container" style="margin-top:7px;">
							<span class="d-inline-block  px-2"> <a
								aria-label="你还没有任何消息"
								class="notification-indicator tooltipped tooltipped-s float-right js-socket-channel js-notification-indicator"
								href="/weshare/priletter/selectpriletter"> <span
									class="mail-status "></span> <svg class="octicon octicon-bell"
						...
						</span> <c:if test="${haveNewLetter eq 'yes' }">
								<span class="repo-language-color float-right"
									style="background-color:red;margin-top:2px;width:7px;height:7px;position:relative;bottom:10px;right:6px;"></span>
							</c:if>
						</li>
						...
						<li class="dropdown js-menu-container">
							...
							<div id="xiala"
								...
								<div id="dianji" class="HeaderNavlink name mt-1">
									<img alt="@Yuhn-z" class="avatar float-left mr-1"
										src="${ctx }/static/${user.uHead }" width="20" height="20">
								...
								<ul class="dropdown-menu dropdown-menu-sw">
									...
									<li><a class="dropdown-item"
										href="/weshare/user/updateinformation"> 个人设置 </a></li>
									<li>
									...
									<li>
										<form class="logout-form" action="/weshare/user/logout"
			...
			<div class="container-lg clearfix px-3 mt-4">
              ...
              <span>zyh</span>
					...
					<div style="margin-top:10px;">
						...
						<JButton type="JButton" id="upload"
							class="mybtn2 guanzhu float-left sixin" style="width:100px;">私信</JButton>
					</div>
				...
				<div id="myfix" class="col-9 float-left pl-2">
					...
					<div id="mynav2"
						...
						<nav class="UnderlineNav-body" data-pjax="" role="navigation">
							...
							</a> <a href="/weshare/article/otherarticles"
								class="UnderlineNav-item " aria-selected="false" role="tab"
								title=""> 他的动态 <span class="Counter">
									 ${authorDev.articlesNum }  </span><a href="/weshare/focus/otherfocus"
								class="UnderlineNav-item "> 他的关注 <span class="Counter">
										${authorDev.focusNum } </span>
							</a> <a href="/weshare/focus/otherfans"
								class="UnderlineNav-item selected"> 他的粉丝 <span
									class="Counter"> ${authorDev.beFocusNum } </span>
							</a>
						</nav>
					</div>
					...
					<div class="position-relative">
						<div id="user-repositories-list">
							...
							<div class="position-relative">
								...
								<c:if test="${empty otherFans }">
									<div id="user-repositories-list">
										<div class="blankslate mt-5">
											<h4 style="font-weight:500;font-size:15px;">还没有人关注他哦!</h4>
										</div>
									</div>
								</c:if>

								<c:forEach items="${otherFans }" var="fans">
									...
									<div
										...
										<c:if test="${fans.username  eq user.username}">
										</c:if>
										<c:if test="${fans.username ne user.username}">
											<div class="d-table-cell col-2 v-align-top text-right">

												<c:if test="${fans.uFocus eq 'focus' }">
													<JButton type="JButton" data-id="${fans.username }"
														class="mybtn2 float-left btn-sm focusbtn1">√已关注</JButton>
												</c:if>
												<c:if test="${fans.uFocus eq 'notfocus'}">
													<JButton type="JButton" data-id="${fans.username }"
	...
	<div id="theme-popover" class="theme-popover"
		style="height:450px;width: 750px;display: none;">
		<div class="theme-poptit">
			<a href="javascript:;" title="关闭" class="close">×</a>
			<h3>weshare-发送私信</h3>
		</div>
		<div class="letter-main">
			<form action="" id="letterfor" method="post"
				...
				<div>
					<div>
						<input type="text" name="pTitle" tabindex="1" autoComplete="off"
							class="form-control" size="79.8" value="" placeholder="私信标题"
							id="letterhead" required="required" />
					</div>
				</div>
				<br />
            ...
            setTimeout(function () {
				...
				<div id="container">
					<span class="float-left">消息内容&emsp;&emsp;&emsp;</span>
					<div class="float-left">
						<a href="JavaScript:void(0)" id="message_face"><img
							src="${ctx }/img/b.png" width="20px" height="20px"
          ...
          <br /> --%>
					...
					<textarea id="msg" name="pText" class="form-control letter-size1"
						placeholder="说点什么~" tabindex="2" required="required"></textarea>
					<br />
					<br />
				</div>
				<input class="mybtn btn-color1 guanzhu float-left letterbtn"
					style="margin-left:390px;background-color:#fff;color:#000;border: 1px solid"
					type="JButton" id="quxiao" tabindex="6" value="取消" /> <input
					class="mybtn btn-color1 guanzhu float-left letterbtn"
					style="margin-right:0px;" type="JButton"
					data-manid="${authorDev.uId}" id="lettersend" tabindex="6"
					value="发送" />
			</form>
		</div>
...
<script src="${ctx }/emotions/jquery.emoticons.js"
