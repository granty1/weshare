					...
					<div id="mynav2"
						...
						<nav class="UnderlineNav-body">
							<a href="/weshare/file/itempage" class="UnderlineNav-item ">
								...
								class="UnderlineNav-item selected" > 我的动态 <span class="Counter">
								 ...
								 <c:if test="${empty myarticles }">
									<div id="user-repositories-list">
										<div class="blankslate mt-5">
											<h4 style="font-weight:500;font-size:15px;">你还没有发表动态哦!</h4>
										</div>
									</div>
								</c:if>
									 ...
									 <li
										...
										<div id="showinfo" class="d-inline-block mb-1 showinfo2">
											<h3>
												<a href="javascript:;" itemprop="name codeRepository"
													style="float:left;">${article.aName}</a><a
...
<!--  ----------------------------------------------------------------------------------  -->
										...
										<div class="float-right">
											...
											<div
											<c:url value="/article/del" var="deleteurl">
											<c:param name="aId" value="${article.aId }"></c:param>
										</c:url>
												class="js-toggler-container js-social-container starring-container ">
												</a>&emsp; <a href="${deleteurl }"><img
										...
										<div class="fileinfo1">
											<p class="col-9 d-inline-block text-gray mb-2 ml"
												style="width:660px;" itemprop="description">${article.aText}</p>
										</div>
																				&emsp; 发表时间：
											<relative-time datetime="" title="">${article.aCtime }</relative-time>
											&emsp;
										</div>
									</li>
